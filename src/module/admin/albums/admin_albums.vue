              ...
              <ul class="albumsUl">
                ...
                <li class="albumLi" v-for="albumType in albumTypes">
                  <a :href="'/admin/albums?id=' + albumType.album_id">
                    <div class="box_shadaw">
                      <img :src="service_url+ '/albumImg/' +albumType.album_cover" style="width:100%; height:100%;" alt=""/>
                      <div class="imgText">
                ...
                <li class="albumLi" v-for="albumTag in albumTags">
                  <a :href="'/admin/albums/photos?id=' + albumTag.album_id">
                    <div class="box_shadaw">
                      <img :src="service_url+ '/albumImg/' +albumTag.album_cover" style="width:100%; height:100%;" alt=""/>
                      <div class="imgText">
                        {{ albumTag.album_name }}
                      </div>
                    </div>
