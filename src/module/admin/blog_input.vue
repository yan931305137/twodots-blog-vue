    ...
    <div class="index-footer-big">
      <div class="ui container">
        <div class="ui">
            ...
            <div class="required field">
              <div class="ui left labeled action input">
                ...
                <select class="ui search dropdown" v-model="blog_type" @change="newType()">
                  <option v-for="type in types" :value="type.type_tag_id" v-if="!type.type_tag_level">
                    {{ type.type_tag_name }}
                  </option>
                </select>
              </div>
            ...
            <div class="field">
              <div class="ui left labeled action input tag_right">
                ...
                <select class="ui fluid search dropdown" v-model="tags" multiple>
                  <option v-for="type in types" :value="type.type_tag_id" v-if="type.type_parent_id===blog_type">
                    {{ type.type_tag_name }}
                  </option>
                </select>
              </div>
          ...
          <div class="required field">
            <textarea class="input_describe" placeholder="博客描述" maxlength="200"
                      v-model="blog.blog_description"></textarea>
          </div>

          <div class="required field">
            <mavon-editor defaultOpen="preview" v-model="blog.blog_content" ref="content_img" @imgAdd="addImg"
                          @imgDel="delImg"></mavon-editor>
            <br>
          </div>
          ...
          <div class="required field ">
            <div class="ui left labeled input home_picture" style="width: 30%">
              ...
              <img :src="service_url+ 'firstImg/' +blog.blog_first_img" style="height: 50px" v-if="blog.blog_first_img"
